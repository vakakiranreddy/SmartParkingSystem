...
namespace SmartParkingSystem.Migrations
{
    ...
    [Migration("20250927082334_notificationModelChanged")]
    partial class notificationModelChanged
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartParkingSystem.Models.Guest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartParkingSystem.Models.ParkingSession", b =>
                {
                    b.HasOne("SmartParkingSystem.Models.Guest", "Guest")
                        .WithMany()
